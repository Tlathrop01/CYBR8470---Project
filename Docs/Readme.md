...
3. To fulful user story 3 local leaders must be able to GET the votes of each issue.
4. To fulfil user story 4 anonymous users must be able to GET the list of issues.
